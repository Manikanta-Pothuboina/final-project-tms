...
import { AdminLeaveRequestUpdate } from "./pages/AdminLeaveRequestUpdate";
import { EmployeeLeaveCheck } from "./pages/EmployeeLeaveCheck";
import { EmployeeLeaveStatusList } from "./pages/EmployeeLeaveStatusList";
...
import { EmployeeReportCheckList } from "./pages/EmployeeReportCheckList";
...
function App() {
  ...
  return (
    <>
      ...
      <Route exact path="/employee-task-checkform" component={EmployeeTaskAssignCheck} />
      <Route exact path="/employee-task-checklist" component={EmployeeTaskAssign} />
      <Route exact path="/employee-report-list" component={EmployeeReportList} />
      <Route exact path="/employee-report-checkform" component={EmployeeReportCheck} />
      ...
      <Route exact path="/employee-profile-update" component={EmployeeProfileUpdate} />
      ...
      <Route exact path="/employee-task-report-checklist" component={EmployeeReportCheckList} />
